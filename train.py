...
def main():
    ...
    parser.add_argument('--rgb_dataset', type=str, default='/home/minmaxhong/Dataset/KAIST', help='path of rgb dataset')
    parser.add_argument('--ir_dataset', type=str, default='/home/minmaxhong/Dataset/KAIST', help='path of ir dataset')
    parser.add_argument('--test_images', type=str, default='/home/minmaxhong/Dataset/ROADSCENE', help='path of image visualization')
